...
jQuery(document).ready(function($) {
	...
	var changeTitleBarOptions = function() {
		
		if (jQuery('#titlebar_style').length == 0) {
			return;
		}
		
		if (jQuery('#titlebar_style').val() == 'style3') {
			jQuery('#setting_page_title_icon').show();
			jQuery('#setting_page_title_icon_upload').show();
		} else {
			jQuery('#setting_page_title_icon').hide();
			jQuery('#setting_page_title_icon_upload').hide();
		}
	};
	
	jQuery('#titlebar_style').change( function() {
		changeTitleBarOptions();
	});
	changeTitleBarOptions();
	
	var changeContactFormOptions = function() {
		
		if (jQuery('#footer_style').length == 0) {
			return;
		}
		
		if (jQuery('#footer_style').val() === 'alternative') {
			jQuery('#setting_footer_cf_font_style').show();
			jQuery('#setting_footer_cf_font_size').show();
			jQuery('#setting_footer_cf_color').show();
			jQuery('#setting_footer_cf_header').show();
			jQuery('#setting_footer_cf_name_label').show();
			jQuery('#setting_footer_cf_name_icon').show();
			jQuery('#setting_footer_cf_email_label').show();
			jQuery('#setting_footer_cf_email_icon').show();
			jQuery('#setting_footer_cf_message_label').show();
			jQuery('#setting_footer_cf_send_label').show();
			jQuery('#setting_footer_cf_submit_style').show();
		} else {
			jQuery('#setting_footer_cf_font_style').hide();
			jQuery('#setting_footer_cf_font_size').hide();
			jQuery('#setting_footer_cf_color').hide();
			jQuery('#setting_footer_cf_header').hide();
			jQuery('#setting_footer_cf_name_label').hide();
			jQuery('#setting_footer_cf_name_icon').hide();
			jQuery('#setting_footer_cf_email_label').hide();
			jQuery('#setting_footer_cf_email_icon').hide();
			jQuery('#setting_footer_cf_message_label').hide();
			jQuery('#setting_footer_cf_send_label').hide();
			jQuery('#setting_footer_cf_submit_style').hide();
		}
	};
	
	jQuery('#footer_style').change( function() {
		changeContactFormOptions();
	});
	changeContactFormOptions();
});
