...
function td_get_banner($id) {
	...
	if ($banner) {
		...
		$background_video = get_post_meta($id,'background_video',true);
		$background_video_format = get_post_meta($id,'background_video_format',true);
		...
		$banner_html .= $background_video_html;
		$banner_html .= '<div class="banner-inner container_16" '.$styles_inner_html.'>';
		$banner_html .= $content;
		$banner_html .= '</div>';
		$banner_html .= '</div>';
		$banner_html .= '<div class="banner-overlay"></div>';
		$banner_html .= '</div><div class="clear"></div>';
		return $banner_html;
	}
}