...
<!--<form class="update-totals shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">-->

	<div class="update-totals">
		<h4><?php _e('Estimate Shipping', 'marine'); ?></h4>

		<section class="shipping-calculator-form-not-hidden">
			...
			<p><button type="submit" name="calc_shipping" value="1" class="unfilled small button"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
