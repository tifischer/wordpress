			...
			<?php if (have_posts()) : ?>
				<div id="post-items">
					<?php while (have_posts()):  the_post();
						...
						endforeach;
						?>
						<div class="col-lg-3 col-md-3 col-sm-6 project-item mix <?php echo implode(' ', $cat); ?>">
							<div class="project">
								...
								<div class="project-meta">
									<h4><?php echo ts_get_shortened_string_by_letters(get_the_title(),12); ?></h4>
									<span class="project-category"><?php echo ts_get_shortened_string_by_letters(implode(',', $cat1),15); ?></span>
