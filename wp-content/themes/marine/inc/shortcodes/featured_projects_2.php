				...
				<div class="col-lg-4 col-md-4 col-sm-4 mix <?php echo $cat_html; ?>">
					<div class="project light">
						<div class="project-image">
							<?php ts_the_resized_post_thumbnail('featured_projects_2', get_the_title(), 'img-responsive'); ?>
						...
						<div class="project-meta">
							...
							<span class="project-category"><?php echo ts_get_shortened_string_by_letters($cat1_html, 30); ?></span>
							<div class="project-like" data-post="<?php echo get_the_ID(); ?>">
