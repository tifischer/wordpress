...
require_once get_template_directory() . '/inc/shortcodes/button_2.php';
...
require_once get_template_directory() . '/inc/shortcodes/featured_projects_4.php';
...
function ts_get_shortcodes_list()
{
    $aHelp = array(
        ...
        */
		...
		array(
            'shortcode' => 'button_2',
            'name' => __('Button 2', 'framework'),
            'description' => '',
            'usage' => '[button_2 animation="bounceInUp" icon="icomoon-home" color="#555555" url="http://yourdomain.com" target="_blank"]Your content here...[/button_2]',
            'code' => '[button_2 animation="{animation}" icon="{icon}" color="{color}" target="{target}" url="{url}"]{content}[/button_2]',
            'fields' => array(
                'animation' => ts_get_animation_effects_settings(),
				'icon' => array(
                    'type' => 'select',
		...
		array(
            ...
            'description' => '',
            'usage' => '[featured_projects_4 animation="bounceInUp" category_filter="yes" category_filter_color="#FFF" category_filter_background="#333" category_filter_border="#DDD" category="" limit="6" hover_color="#FF0000"]',
            'code' => '[featured_projects_4 animation="{animation}" category_filter="{categoryfilter}" category_filter_color="{categoryfiltercolor}" category_filter_background="{categoryfilterbackground}" category_filter_border="{categoryfilterborder}" category="{category}" limit="{limit}" hover_color="{hovercolor}"]',
            'fields' => array(
                'animation' => ts_get_animation_effects_settings(),
                'categoryfilter' => array(
                    'type' => 'select',
				...
				'hovercolor' => array(
                    'type' => 'colorpicker',
                    'label' => __('Hover color', 'framework'),
                    'desc' => ''
                ),
            )
        ),
		...
		array(
			...
			'code' => '[icon animation="{animation}" icon="{icon}" icon_upload="{iconupload}" icon_color="{iconcolor}" title="{title}" title_size="{titlesize}" title_font_weight="{titlefontweight}" title_color="{titlecolor}" content_size="{contentsize}" content_color="{contentcolor}"]{content}[/icon]',
			'fields' => array(
				'animation' => ts_get_animation_effects_settings(),
				'icon' => array(
					'type' => 'select',
				...
				'iconupload' => array(
					'type' => 'upload',
					'label' => __('Upload icon (choose or enter value below)', 'framework'),
					'desc' => ''
				),
				'iconcolor' => array(
					'type' => 'colorpicker',
				...
				'titlesize' => array(
					'type' => 'text',
					'label' => __('Title font size (px)', 'framework'),
					'desc' => ''
				),
				'titlefontweight' => array(
                    'type' => 'select',
                    'label' => __('Title font weight', 'framework'),
                    'values' => array(
				...
				'contentsize' => array(
					'type' => 'text',
					'label' => __('Content font size (px)', 'framework'),
					'desc' => ''
				),
				'contentcolor' => array(
					'type' => 'colorpicker',
		...
		array(
			...
			'usage' => '[map_container address="Your address" zoom="14" custom_marker="" full_width="no" grayscale="no" height="230" marker_offset="-140" first_page="no" last_page="yes"][wpgmappity id="x"][/map_container]',
			'code' => '[map_container address="{address}" zoom="14" custom_marker="{custommarker}" full_width="{fullwidth}" grayscale="{grayscale}" height="{height}" marker_offset="{markeroffset}" first_page="{firstpage}" last_page="{lastpage}"][/map_container]',
			'fields' => array(
				'address' => array(
					'type' => 'text',
        ...
        array(
            ...
            'code' => '[special_text animation="{animation}" tagname="{tagname}" color="{color}" font_size="{fontsize}" font_weight="{fontweight}" font_style="{fontstyle}" font="{font}" margin_top="{margintop}" margin_bottom="{marginbottom}" align="{align}"]{content}[/special_text]',
            'fields' => array(
                'animation' => ts_get_animation_effects_settings(),
                'tagname' => array(
                    'type' => 'select',
		...
		array(
			...
			'code' => '[testimonials animation="{animation}" variant="{variant}" category="{category}" limit="{limit}" text_color="{textcolor}" info_color="{infocolor}" nav_style="{navstyle}"]',
			'fields' => array(
				'animation' => ts_get_animation_effects_settings(),
				'variant' => array(
                    'type' => 'select',
