			...
			<?php if (have_posts()) : ?>
				<div id="post-items">
					<?php while (have_posts()):  the_post();
						...
						endforeach;
						?>
						<div class="col-lg-4 col-md-4 col-sm-6 project-item mix <?php echo implode(' ', $cat); ?>">
							<div class="project">
								...
								<div class="project-meta">
									...
									<span class="project-category"><?php echo ts_get_shortened_string_by_letters(implode(',', $cat1),20); ?></span>
